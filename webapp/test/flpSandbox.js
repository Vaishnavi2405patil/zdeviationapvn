		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zdeviationapvn-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zdeviationapvn-display": {
								"semanticObject": "zdeviationapvn",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zdeviationapvn",
									"url": sap.ui.require.toUrl("zdeviationapvn")
								}
							}
						}
					}
