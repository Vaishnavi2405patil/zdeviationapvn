sap.ui.define(
  ...
  function (
    ...
    return Controller.extend(
      "zdeviationapvn.controller.DeviationApprovalMaster",
      {
        onInit: function () {
          if (!this._oDialogDeviationApproval) {
            this._oDialogDeviationApproval = sap.ui.xmlfragment(
              "zdeviationapvn.fragments.DeviationApproval",
              this
            );
                ...
                "')",
              {
                success: function (odata, oResponse) {
                  if (odata.ValidSig1 === true) {
                    ...
                    var smsg =
                      "You are not the right signatory1 for this purchase order. ";
